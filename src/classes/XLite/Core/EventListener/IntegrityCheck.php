 ...
 * RemoveData
 */
class IntegrityCheck extends \XLite\Core\EventListener\Base\Countable
{
     ...
     * Get items
     *
     * @return \XLite\Logic\IntegrityCheck\Generator
     */
    protected function getItems()
    {
        if (!isset($this->generator)) {
            $this->generator = new \XLite\Logic\IntegrityCheck\Generator(
