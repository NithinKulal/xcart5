...
class ExpressCheckout extends \XLite\Module\CDev\Paypal\View\Button\AExpressCheckout
{
    ...
    {
        return 'modules/CDev/Paypal/button/add2cart_popup/default/express_checkout.twig';
    }
    ...
    protected function getTemplate()
    {
        return $this->isInContextAvailable()
            ? 'modules/CDev/Paypal/button/add2cart_popup/in_context/express_checkout.twig'
            : 'modules/CDev/Paypal/button/add2cart_popup/default/express_checkout.twig';
    }
