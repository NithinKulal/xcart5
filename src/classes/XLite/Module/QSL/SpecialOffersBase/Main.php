 ...
 * 
 * 5.2.2
 * - fixed the issue with the inability to add new offers when all existing
 *   offers have been deleted
 * 5.2.3
 * - fixed the issue with the incorrect retrieval of the list of available
 *   offer types
 * 5.2.4
 * - tweaks to labels
 * - switched to the new method of adding items to the primary storefront menu
 * 
 * -----------------------------------------------------------------------------
 * 
 * @category  X-Cart 5
...
abstract class Main extends \XLite\Module\AModule
{
    ...
    public static function runBuildCacheHandler()
    {
        ...
        \XLite\Core\Layout::getInstance()->removeTemplateFromList('shopping_cart/parts/item.subtotal.tpl', 'cart.item');
