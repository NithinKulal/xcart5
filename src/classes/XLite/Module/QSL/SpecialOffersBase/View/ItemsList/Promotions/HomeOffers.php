 ...
 */
class HomeOffers extends \XLite\Module\QSL\SpecialOffersBase\View\ItemsList\Promotions\APromotedOffers
{
    /**
    ...
    protected function getSearchCondition()
    {
        ...
        $cnd->{\XLite\Module\QSL\SpecialOffersBase\Model\Repo\SpecialOffer::SEARCH_VISIBLE_HOME} = true;
