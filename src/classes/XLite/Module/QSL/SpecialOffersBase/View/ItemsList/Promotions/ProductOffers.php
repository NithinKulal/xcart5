 ...
 */
class ProductOffers extends \XLite\Module\QSL\SpecialOffersBase\View\ItemsList\Promotions\APromotedOffers
{
    /**
     * Widget parameters
     */
    const PARAM_CATEGORY    = 'product';
    const PARAM_CATEGORY_ID = 'product_id';
