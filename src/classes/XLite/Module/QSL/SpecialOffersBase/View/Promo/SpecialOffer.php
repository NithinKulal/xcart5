...
class SpecialOffer extends \XLite\View\AView
{
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams += array(
            static::PARAM_OFFER  => new \XLite\Model\WidgetParam\Object(
                'Special offer',
                null,
                false,
                '\XLite\Module\QSL\SpecialOffersBase\Model\SpecialOffer'
            ),
            static::PARAM_ROW    => new \XLite\Model\WidgetParam\Int('Offer row index in the list', 0),
            static::PARAM_COLUMN => new \XLite\Model\WidgetParam\Int('Offer column index in the list', 0),
        );
    }
