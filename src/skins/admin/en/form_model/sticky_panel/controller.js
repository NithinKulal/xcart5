...
(function () {
  ...
  var StickyPanel = Vue.extend({
    props: ['changed'],
    activate: function (done) {
      done();

      // var el = $(this.$el).find('.sticky-panel');
      // setTimeout(function () {
      //   el.affix({
      //     offset: {
      //       bottom: $(document).height() - el.offset().top + el.find('.box').outerHeight()
      //     }
      //   })
      // }, 0);
  ...
  Vue.component('xlite-sticky-panel', StickyPanel);
