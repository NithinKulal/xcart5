...
(function() {
  ...
  ContentEdit.TagNames.get().register(ContentEdit.Text, 'address', 'blockquote', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'div');
...
(function() {
  ...
  window.ContentTools = {
    ...
    DEFAULT_TOOLS: [['bold', 'italic', 'link', 'align-left', 'align-center', 'align-right'], ['heading', 'subheading', 'sub3heading', 'sub4heading', 'sub5heading', 'paragraph', 'unordered-list', 'ordered-list', 'table', 'indent', 'unindent', 'line-break'], ['image', 'video', 'preformatted'], ['undo', 'redo', 'remove']],
  ...
  ContentTools.Tools.Sub3heading = (function(_super) {
    __extends(Sub3heading, _super);

    function Sub3heading() {
      return Sub3heading.__super__.constructor.apply(this, arguments);
    }

    ContentTools.ToolShelf.stow(Sub3heading, 'sub3heading');

    Sub3heading.label = 'H3';

    Sub3heading.icon = 'subheading';

    Sub3heading.tagName = 'h3';

    return Sub3heading;

  })(ContentTools.Tools.Heading);

  ContentTools.Tools.Sub4heading = (function(_super) {
    __extends(Sub4heading, _super);

    function Sub4heading() {
      return Sub4heading.__super__.constructor.apply(this, arguments);
    }

    ContentTools.ToolShelf.stow(Sub4heading, 'sub4heading');

    Sub4heading.label = 'H4';

    Sub4heading.icon = 'subheading';

    Sub4heading.tagName = 'h4';

    return Sub4heading;

  })(ContentTools.Tools.Heading);

  ContentTools.Tools.Sub5heading = (function(_super) {
    __extends(Sub5heading, _super);

    function Sub5heading() {
      return Sub5heading.__super__.constructor.apply(this, arguments);
    }

    ContentTools.ToolShelf.stow(Sub5heading, 'sub5heading');

    Sub5heading.label = 'H5';

    Sub5heading.icon = 'subheading';

    Sub5heading.tagName = 'h5';
