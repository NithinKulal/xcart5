...
var TemplateNavigator = function () {
  ...
  var switcher = jQuery('#themeTweaker-switcher', controlPanel);

  this.enabled = jQuery.cookie('TemplateNavigator') && switcher.length ? ('1' === jQuery.cookie('TemplateNavigator')) : true;
